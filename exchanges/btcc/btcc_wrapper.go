...
func (b *BTCC) Run() {
	...
	if common.StringDataContains(b.CurrencyPairs.Spot.Enabled.Strings(), "CNY") || common.StringDataContains(b.CurrencyPairs.Spot.Available.Strings(), "CNY") || common.StringDataContains(b.BaseCurrencies.Strings(), "CNY") {
