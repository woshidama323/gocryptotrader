...
func TestGetEnabledPairs(t *testing.T) {
	...
	b.CurrencyPairs.Spot.Enabled = currency.NewPairsFromStrings([]string{"BTC-USD"})
...
func TestGetAvailablePairs(t *testing.T) {
	...
	b.CurrencyPairs.Spot.Available = currency.NewPairsFromStrings([]string{"BTC_USD"})
	b.CurrencyPairs.RequestFormat.Delimiter = ""
	b.CurrencyPairs.ConfigFormat.Delimiter = "_"
	c = b.GetAvailablePairs(assetType)
	if c[0].Base != currency.BTC && c[0].Quote != currency.USD {
...
func TestSupportsPair(t *testing.T) {
	...
	b.CurrencyPairs.Spot.Available = currency.NewPairsFromStrings([]string{defaultTestCurrencyPair, "ETH-USD"})
	b.CurrencyPairs.Spot.Enabled = currency.NewPairsFromStrings([]string{defaultTestCurrencyPair})
